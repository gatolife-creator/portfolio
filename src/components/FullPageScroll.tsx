      ...
      <FullPageSections>
        <FullpageSection className="h-screen w-full flex justify-center items-center -z-50">
          <>
            ...
            >
              <img
                className="mask mask-circle mx-auto mt-48 mb-5 sm:w-[240px] w-[180px]"
                src={ProfileImg}
                alt="GatoLifeIcon"
              />
              <h3 className="font-bold sm:text-4xl text-2xl">GatoLife</h3>
              <p className="mt-5">
          ...
          <div className="text-center p-2">
            ...
            <div className="grid grid-cols-5 gap-4 text-left mt-5">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="sm:w-28 w-[58px] self-center text-sm me-0 flex"
              >
